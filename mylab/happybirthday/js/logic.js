...
function startAnimation() {
	$('body').prepend("<div style=\"background-image:url(./pics/1.JPG);display:none;\">preload</div><div style=\"background-image:url(./pics/2.JPG);display:none;\">preload</div><div style=\"background-image:url(./pics/3.JPG);display:none;\">preload</div><div style=\"background-image:url(./pics/4.JPG);display:none;\">preload</div><div style=\"background-image:url(./pics/5.JPG);display:none;\">preload</div>");
